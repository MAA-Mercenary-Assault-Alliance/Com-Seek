  ...
  <div class="pt-10 pb-32">
    ...
    >
      ...
      <div v-if="alert.message" class="mb-4">
        <div
          :class="`alert ${alert.type === 'error' ? 'alert-error' : 'alert-success'}`"
        >
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div class="form-control">
          <label class="label"
            ><span class="label-text">Account Email</span></label
          >
          <input
        ...
        <div class="form-control">
          <label class="label"
            ><span class="label-text">Company Name</span></label
          >
          <input
            ...
            required
          />
          <label v-if="errors.companyName" class="label text-error text-sm">{{
            errors.companyName
          }}</label>
        </div>
        ...
        <div class="form-control">
          ...
          <input
            ...
            required
          />
          <label v-if="errors.location" class="label text-error text-sm">{{
            errors.location
          }}</label>
        </div>
        ...
        <div class="form-control">
          <label class="label"
            ><span class="label-text">Contact Email</span></label
          >
          <input
            ...
            required
          />
          <label v-if="errors.contactEmail" class="label text-error text-sm">{{
            errors.contactEmail
          }}</label>
        </div>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (!this.form.contactNumber.trim())
        this.errors.contactNumber = "Required";
