...
<template>
  <div class="flex bg-background justify-between items-center top-0 w-full min-h-18 p-4 text-black px-42 text-xl flex-wrap">
    <ul class="flex space-x-4 items-center">
      ...
      <li class="font-[righteous] text-3xl"><router-link to="/home">Com-Seek</router-link></li>
